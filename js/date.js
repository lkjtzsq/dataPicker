    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'>请选择起始截止日期</div><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
                        ...
                        if ($(this).text() == '截止') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                ...
                                if ($(this).text() == '截止') {
                                    ...
                                    var day = $(this).parent().text().split('截')[0];
                                    if(day < 10){
                                        day = "0" + day;
                                    }
            ...
            _initselected: function() {
                ...
                tds.each(function(index, element) {
                    if ($(this).text() == strDays) {
                        var r = index;
                        $(this).append('</br><p class="rz">起始</p>');
                        if ($(this).next().text() != "") {
                            $(this).next().append('</br><p class="rz">截止</p>');
                        } else {
                            $(".dateTable").eq(1).find("td").each(function(index, el) {
                                if ($(this).text() != "") {
                                    $(this).append('</br><p class="rz">截止</p>');
                                    return false;
                                }
                            });
                        }
                ...
                $(arry1).on('click', function(index) {
                    ...
                    if (flag == 0) {
                        ...
                        $(me.sections).find('.rz').each(function(index, element) {
                            if ($(this).text() == '起始') {
                                $(this).parent('td').append('<span class="hover ruzhu_hover">选择截止日期</span>');
                        ...
                        $(me.sections).find('.rz').each(function(index, element) {
                            if ($(this).text() == '截止') {
                                $(this).parent('td').append('<span class="hover lidian_hover">共' + (sum+1) + '天</span>');
                                $(this).parent('td').css('position', 'relative');
                            }
